<!-- Modal -->
<div class="modal fade" id="new-keyword" tabindex="-1" role="dialog" aria-labelledby="createkeywordLabel" aria-hidden="true">
<div class="modal-dialog" role="document">
  <div class="modal-content">
    <div class="modal-header main-area">
      <div class="head-panel px-5 py-3">
      <h5 class="modal-title text-white" id="createkeywordLabel"><strong>Add new keyword</strong></h5>
      </div>
    ...
    <div class="modal-body">
       ...
       <form method="POST" id="add-keyword" action="{{ route('keywords.store') }}">
       {{ csrf_field() }}
       ...
       <div class="form-group mu-3 mb-3 mr-2 ml-2">
          ...
          <select class="form-control form-control-sm" name="keyword_category_id" required>
        ...
        <div class="form-group mu-3 mb-3 mr-2 ml-2">
          <label for="title" class="control-label"><strong>Keyword</strong></label>
    ...
    <div class="modal-footer main-area">
      ...
      <button class="btn btn-block main-btn" form="add-keyword" type="submit"><i class="fas fa-fw fa-angle-double-right"></i> Add Keyword(s)</button>
    </div>
  </div>
</div>
</div>