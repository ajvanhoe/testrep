...
<div class="modal-dialog" role="document">
  <div class="modal-content">
    <div class="modal-header main-area">
      <div class="bg-gradient-red  px-5 py-3">
      <h5 class="modal-title text-white" id="removeCategoryLabel"><strong>Remove category</strong></h5>  
      </div>
    ...
    <div class="row my-5">
      <div class="col-md-8">
        <form method="POST" id="remove-category-{{$category->id}}" action="{{ route('keywords_category.destroy', $category->id) }}">
          {{ csrf_field() }}
          @method('DELETE')
