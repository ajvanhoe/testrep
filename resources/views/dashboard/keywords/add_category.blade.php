...
<div class="modal-dialog" role="document">
  <div class="modal-content">
    <div class="modal-header main-area">
      <div class="head-panel px-5 py-3"><h5 class="modal-title text-white " id="createCategoryLabel"><strong>Add new category</strong></h5></div>
    ...
    <div class="modal-body">
       ...
       <form method="POST" id="add-category" action="{{ route('keywords_category.store') }}">
       {{ csrf_field() }}
