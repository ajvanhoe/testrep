...
<div>
    <div class="swiper-container swiper-parent">
        <div class="swiper-wrapper">
            <div class="swiper-slide dark" style="background-image: url('theme/images/hero/buy-gold-2020.jpg');">
                <div class="container clearfix">
                    <div class="heading-top">
                        <div class="heading-home-top">
                       
                        <h1 data-animate="fadeInUp">BUY GOLD - AFRICAN SOVEREIGN INVESTMENT STAREGIC PARTNERS LTD.</h1>
                        <div class="heading-divider"></div>
                        <div class="heading-text">
                            <p class="d-none d-sm-block" data-animate="fadeInUp" data-delay="200">Buy Gold Legally from African Sovereign Investment Strategic Partners Ltd company and its licensed dealer. Get the best price and full logistic assistance.</p>
                        </div>
                        </div>
                    </div>
                </div>
            ...
            <!-- <div class="swiper-slide dark">
                ...
                <div class="video-wrap">
                    <video poster="theme/images/videos/1.jpg" preload="auto" loop autoplay muted>
                        <source src='theme/images/videos/1.webm' type='video/webm' />
                        <source src='theme/images/videos/1.mp4' type='video/mp4' />
                        
                    </video>
                    <div class="video-overlay" style="background-color: rgba(0,0,0,0.2);"></div>
                </div>
            </div>
            <div class="swiper-slide dark" style="background-image: url('theme/images/page/slider-2.jpg'); background-position: center top;">
                <div class="container clearfix">
    ...
    <a href="#" data-scrollto="#home-lead" data-easing="easeInOutExpo" data-speed="1250" data-offset="65" class="one-page-arrow dark"><i class="icon-angle-down infinite animated fadeInDown"></i></a>
...
<section id="home-lead" class="section bg-gray divider-gray nomargin">
    <div class="container clearfix">
        ...
        <div class="col_half bottommargin-sm col_last img-col">
...
<div class="row clearfix align-items-stretch">
    ...
    <div class="col-lg-6 col-padding bg-gray">
...
<div class="section parallax dark bg-cover nomargin noborder" style="background-image: url('{{asset('theme/images/asisp/asisp-contact-us.jpg')}}');"  data-bottom-top="background-position:0px 0px;" data-top-bottom="background-position:0px -200px;" data-stellar-vertical-offset="50">
	<div class="container clearfix">
            <div class="main-section divcenter">
		    <div class="image-panel col_full center mt-5"> 
			<h2 class="mt-5">​BUY GOLD ONLINE</h2>		
